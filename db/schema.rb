...
ActiveRecord::Schema.define(:version => 20121217220129) do
  ...
  create_table "spree_container_taxonomies", :force => true do |t|
    t.string   "name"
    t.datetime "created_at",   :null => false
    t.datetime "updated_at",   :null => false
  ...
  create_table "spree_container_taxonomies_warehouses", :force => true do |t|
    t.integer "warehouse_id"
    t.integer "container_taxonomy_id"
  end

  create_table "spree_container_taxons", :force => true do |t|
    t.string   "name"
    t.string   "permalink"
    t.integer  "position"
    t.integer  "parent_id"
  ...
  create_table "spree_destocking_reasons", :force => true do |t|
    t.string   "name"
    t.string   "description"
    t.datetime "created_at",  :null => false
    t.datetime "updated_at",  :null => false
  ...
  create_table "spree_packages", :force => true do |t|
    t.string   "tracking_number"
    t.datetime "created_at",         :null => false
    t.datetime "updated_at",         :null => false
    t.integer  "shipment_id"
    t.integer  "container_taxon_id"
  end
  ...
  create_table "spree_stock_records", :force => true do |t|
    ...
    t.integer  "container_taxon_id"
    t.string   "direction"
    t.integer  "destocking_reason_id"
  ...
  create_table "spree_variant_container_taxons", :force => true do |t|
    t.integer  "variant_id"
    t.integer  "container_taxon_id"
    t.datetime "created_at",                      :null => false
    t.datetime "updated_at",                      :null => false
  ...
  create_table "spree_variants", :force => true do |t|
    ...
    t.integer  "position"
    t.string   "visual_code"
  end

  add_index "spree_variants", ["product_id"], :name => "index_variants_on_product_id"

  create_table "spree_visual_code_types", :force => true do |t|
    t.string   "name"
    t.datetime "created_at",                   :null => false
    t.datetime "updated_at",                   :null => false
  ...
  create_table "spree_warehouses", :force => true do |t|
    t.string   "name",       :null => false
    t.string   "code"
    t.text     "location"
    t.text     "details"
